...
class AStar:
    """
        This class will find the shortest path between two points
        """
    ...
    def astar(self, game_map, start, goal):
        """
        ...
        while open_heap:
            ...
            for neighbour in neighbours:
                ...
                if game_map[neighbour] >= self.game_map.TILES.INACCESSIBLE.value:
                    # # Allow for paths to a goal that is an unwalked tile
                    # # This is used to walk to a mineable mountain
                    # if neighbour == goal:
                    #     came_from[neighbour] = current
                    #     came_from[goal] = neighbour
                    #     return self.build_path(came_from, neighbour)
                    continue
